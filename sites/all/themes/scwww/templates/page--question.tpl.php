<div id="page" class="<?php print $classes; ?>"<?php print $attributes; ?>>
    ...
    <header id="header">
        <div id="disclaimer"><div class="container">You are currently working on this website as an ongoing development project. <a href="http://digital.southbankcentre.co.uk/" target="_blank">Click here</a> to find out more.</div></div>
        <div class="container">
            ...
            <div id="header-region">
                ...
                <?php if ($logo): ?>
                    <a href="http://www.southbankcentre.co.uk" title="<?php print t('Home'); ?>" rel="home" id="logo">
    ...
    <div id="main">
        <div class="container group">
            ...
            <?php if ($page['pre_content']): ?>
                <div id="region-pre-content" class="col-12"><?php print render($page['pre_content']) ?></div>
            ...
            <div class="row">
                ...
                <?php if ($page['post_content']): ?>
                    <section id="region-post-content" class="col-9">
